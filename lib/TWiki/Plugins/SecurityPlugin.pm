...
#    $exampleCfgVar = TWiki::Func::getPluginPreferencesValue( "EXAMPLE" ) || "default";
    $SecurityLockedCfgVar =
      TWiki::Func::getPluginPreferencesValue("SECURITYLOCKED") || "LOCKED";
    $SecurityUnlockedCfgVar =
      TWiki::Func::getPluginPreferencesValue("SECURITYUNLOCKED") || "UNLOCKED";
...
### my ( $text, $topic, $web ) = @_;   # do not uncomment, use $_[0], $_[1]... instead
    ...
    TWiki::Func::writeDebug("- ${pluginName}::handleSecurity( $_[2].$_[1] )")
      if $debug;
